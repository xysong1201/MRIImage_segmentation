...
class up(nn.Module):
    def __init__(self, in_channel, out_channel, indice = None):
...
class Decoder(nn.Module):
    def __init__(self, in_channel, out_class, idx1, idx2, idx3, idx4, x4,x3,x2,x1):
        ...
        self.up1 = up(in_channel, in_channel, indice = idx4)
        self.up2 = up(in_channel, in_channel, indice = idx3)
        self.up3 = up(in_channel, in_channel, indice = idx2)
        self.up4 = up(in_channel, in_channel, indice = idx1)     
